...
def print_pairwise_dataset_example(example: Dict[str, List[int]], tokenizer: "PreTrainedTokenizer") -> None:
    ...
    print("chosen_input_ids ({}):\n{}".format(len(example["chosen_input_ids"]), example["chosen_input_ids"]))
    print("chosen_inputs:\n{}".format(tokenizer.decode(example["chosen_input_ids"], skip_special_tokens=False)))
    print("chosen_label_ids ({}):\n{}".format(len(example["chosen_labels"]), example["chosen_labels"]))
    print("chosen_labels:\n{}".format(tokenizer.decode(valid_chosen_labels, skip_special_tokens=False)))
    print("rejected_input_ids ({}):\n{}".format(len(example["rejected_input_ids"]), example["rejected_input_ids"]))
    print("rejected_inputs:\n{}".format(tokenizer.decode(example["rejected_input_ids"], skip_special_tokens=False)))
    print("rejected_label_ids ({}):\n{}".format(len(example["rejected_labels"]), example["rejected_labels"]))
